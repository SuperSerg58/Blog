...
urlpatterns = [
    ...
    path('post/<str:slug>/delete/', PostDelete.as_view(), name='post_delete_url'),  # Ссылка на удаление поста
    # Тэги
    ...
    path('tag/<str:slug>/delete/', TagDelete.as_view(), name='tag_delete_url')  # Удаление тега
]
